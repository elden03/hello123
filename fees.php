...
<title> Intrend Interior Category Flat Bootstrap Responsive Website Template | Contact : W3layouts</title>
    ...
    <link rel="stylesheet" href="web_home/css_home/fees.css">
	<!-- //css files -->
...
<div class="form-container">
        ...
        <!-- <form method="POST" action="process_form.php">
            ...
            <label   
 for="fees">Fees to be Paid:</label>
...
<form method="POST" action="remove_student.php">
    <label for="student-id-to-remove">Student ID to Remove:</label>
    <input type="text" id="student-id-to-remove" name="student-id-to-remove" required><br><br>
